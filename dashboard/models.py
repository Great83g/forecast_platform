...
class ForecastSchedule(models.Model):
    ...
    days = models.PositiveIntegerField(default=1)
    horizon_mode = models.CharField(max_length=32, default="weekday_calendar")
    ...
    test_run_time = models.TimeField(default=time(7, 0))
    test_providers = models.CharField(max_length=128, blank=True)
    last_run_at = models.DateTimeField(null=True, blank=True)
    last_test_run_at = models.DateTimeField(null=True, blank=True)
